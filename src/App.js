      ...
      <div className="mainContainer">
        <nav className="navBar">
          <img
            ...
            alt="website logo"
          />
          <ul className="scoreDiv">
            <li className="scoreName">
              <p>
        ...
        <div className="contentDiv">
          {!isTrue && (
            <div className="firstDiv">
              <img src={imgUrl} className="bigImage" alt="match" />
              <ul className="tabElements">
                {tabsList.map(eachValue => (
                  <li key={eachValue.tabId}>
                    <button
                      type="button"
                      className={`tabButton ${
                        category === eachValue.tabId ? 'highlightText' : ''
                      }`}
          ...
          {isTrue && (
            <div className="secondDiv">
              <img
                ...
                alt="trophy"
              />
              <p className="mainHeading">YOUR SCORE</p>
